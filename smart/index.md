...
NDE-based assessments allow the evaluation of process-escape anomalies, defects generated by sub-optimal manufacturing conditions and that can represent harmful elements within a prospective target fatigue life.

![](images/SPF_approach.png)
*The Smart-ProFACE approach towards defect acceptance.*

Smart-ProFACE evaluates the reliability of NDE through the probability of detection and sizing error analyses. These instruments permit to quantify the bias and scatter of the size of detected anomalies, which is directly combined in the fracture mechanics-based fatigue model.
In combination with the uncertainty of the fatigue strength model, a component can be verified through a ***fully-probabilistic***, ***NDE-informed*** approach \[1,2\].
...
The project involves the manufacturing of two space components by laser powder bed fusion:
...
\[2\] Rusnati L., Perghem D., Miccoli S., Luzin V., Senck S., and Beretta S. (2026) “Probabilistic fatigue assessment of a demonstrator manufactured by PBF-LB in Scalmalloy®.” *International Journal of Fatigue* 212, 109771
